...
namespace TransferData
{
    class SystemUnit
    {
        ...
        public static int WM_READBACK = RegisterWindowMessage("PLCREADBACK");
        public static int WM_WRITEBACK = RegisterWindowMessage("PLCWRITEBACK");
        ...
        public static DataTable importData(string Path)
        {
            ...
            try
            {
                ...
                strExcel = "select * from [sheet1$A:D]";
